...
//static const char font[]            = "xft:Terminus:medium:size=10.5";
//static const char font[]            = "Droid:medium:size=10.5";
#define NUMCOLORS 9 
...
/* tagging */
static const char *tags[] = { "main", "code", "www", "vbox", "misc" };

static const Rule rules[] = {
	/* class      instance    title       tags mask     isfloating   monitor */
	{ "Gimp",     NULL,       NULL,       0,            True,        -1 },
	{ "Firefox",  NULL,       NULL,       1 << 8,       False,       -1 },
  { "URxvtc",   NULL,       NULL,       0,            True,        -1 },
};
